...
export default function TetrisLoading({ 
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="mb-4">
        <div className={`border-2 border-gray-800 dark:border-gray-200 bg-white dark:bg-black ${config.padding} transition-colors shadow-xl`}>
          {renderGrid()}
        </div>
      </div>
      ...
      {showLoadingText && (
        <div className="text-center">
          <p className="text-black dark:text-white font-medium transition-colors animate-pulse tracking-wide italic">{loadingText}</p>
        </div>
      )}
    </div>
  )
